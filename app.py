...
class Graph(dbb.Block):
    ...
    html.Div(
        ...
        children=[
            html.Div('Welcome to the Common Sennse Media Twitter Review Tool  <br>  IF PAGE DOES NOT LOAD, PRESS "COMMAND+SHIFT+R" and then Refresh the Page, REPEAT if needed',
